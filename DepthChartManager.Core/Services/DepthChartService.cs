...
namespace DepthChartManager.Core.Services
{
    public class DepthChartService : IDepthChartService
    {
        ...
        public async Task<PlayerDto> AddPlayer(Guid leagueId, Guid teamId, string playerName)
        {
        ...
        public async Task<IEnumerable<PlayerPositionDto>> GetBackupPlayerPositions(Guid leagueId, Guid teamId, Guid playerId, Guid supportingPositionId)
        {
